...
const SingleTicker = () => {
  ...
  return (
    <div className="pl-5 py-2 border">
      <div className="flex items-center gap-5">
        <div>
          <img
            className="rounded-full"
            src="https://i.ibb.co/NYKXFdP/f5ed10ec1625eb393ada7073b9afd17e.png"
            alt=""
          />
          <img
            className="rounded-full -mt-2"
            src="https://i.ibb.co/hYNTSSy/gbp.png"
            alt=""
          />
        </div>
      ...
      <div className="text-left flex gap-5">
        ...
        <div
          className={
            EUR_USD[0] < EUR_USD[1] ? "text-green-500" : "text-red-500"
          }
        >
          <small>
            {EUR_USD[0] < EUR_USD[1] ? "Yes" : "No"},&nbsp;{percentage}%
          </small>
