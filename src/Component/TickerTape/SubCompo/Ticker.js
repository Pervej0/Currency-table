    ...
    return (
        <div className="items-center gap-4 ticker-container">
            <div className="border-r border-gray-400 flex gap-5 pr-4">
                <div className="pr-8">
                    <img className="inline" style={{height: "30px", width: "30px"}} src={CompareCurrency.img} alt=""/> 
                    <small className="font-semibold inline pl-2" style={{fontSize: "12px"}}>EURUSD</small>
                </div>                                    
                <div className="text-left flex gap-5">
                    ...
                    <small>({CompareCurrency.EUR_USD[1] < CompareCurrency.EUR_USD ? "+": "-"}, &nbsp;{percentage}%)</small>
